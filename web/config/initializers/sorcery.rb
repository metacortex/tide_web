...
Rails.application.config.sorcery.configure do |config|
  ...
  config.facebook.user_info_mapping = { :email => "email", :name => "name", :name_e => "name" }
  ...
  config.user_config do |user|
    ...
    user.reset_password_mailer = Notifications                                                          # mailer class. Needed.

    user.reset_password_email_method_name = :reset_password                             # reset password email
