...
Connection.create([
  ...
  # friends
  { user_id:3, target_id:1, connection_type:"co-worker", accepted_at: 3.day.ago },
  { user_id:4, target_id:1, connection_type:"friend", accepted_at: 3.day.ago },
  { user_id:5, target_id:1, connection_type:"classmate", accepted_at: 3.day.ago },
  { user_id:6, target_id:1, connection_type:"co-worker", accepted_at: 3.day.ago },
  { user_id:7, target_id:1, connection_type:"etc", accepted_at: 3.day.ago },
])
